...
function urlSplit(a){"use strict";function b(){var b,c,d=C.protocol;return A&&null!==d?d:(b=a.split("://"),c=b[1]?b[0]:"",C.protocol=c)}function c(){var c,d,e,f=C.authorization;return A&&null!==f?f:(c=b(),c&&(a=a.replace(c+"://","")),d=a.split("@"),e=d[1]?d[0]:"",C.authorization=e)}function d(){var a,b,d,e=C.username;return A&&null!==e?e:(a=c(),b=a.split(":"),d=b[0],C.username=d)}function e(){var a,b,d,e=C.password;return A&&null!==e?e:(a=c(),b=a.split(":"),d=b[1]?b[1]:"",C.password=d)}function f(){var d,e,f,g=C.domain;return A&&null!==g?g:(d=b(),e=c(),d&&(a=a.replace(d+"://","")),e&&(a=a.replace(e+"@","")),f=a.split("/")[0].split(":")[0],C.domain=f)}function g(){var a,b,c=C.domainList;return A&&null!==c?c:(a=f(),b=a.split("."),C.domainList=b)}function h(){var a,b,c=C.domainLevels;return A&&null!==c?c:(a=g(),b=a.slice().reverse(),C.domainLevels=b)}function i(){var d,e,f,g,h,i=C.port;return A&&null!==i?i:(d=b(),e=c(),f=a.replace(d+"://","").replace(e+"@",""),g=f.split("/")[0].split(":"),h=void 0!==g[1]?g[1]:"",C.port=h)}function j(){var d,e,g,h,j,k,l=C.request;return A&&null!==l?l:(d=b(),e=c(),g=f(),h=i(),j=a.replace(d+"://",""),j=j.replace(e+"@",""),j=j.replace(g,""),k=j.replace(":"+h,""),C.request=k)}function k(){var a,b,c=C.path;return A&&null!==c?c:(a=j(),b=a.split("?")[0],C.path=b)}function l(){var a,b,c,d,e=C.pathList;if(A&&null!==e)return e;for(a=k(),d=a.split("/"),b=d.length,c=0;b>c;c++)d[c]=d[c],b-1>c?d[c]=d[c]+"/":""===d[c]?d.splice(-1):d[c]=d[c];return C.pathList=d}function m(){var a,b,c,d,e,f=C.file;return A&&null!==f?f:(a=l(),b=a[a.length-1],b?(c=b?b.split("/"):"",c.length>1?e="":(d=b.split("."),e=d[1]?b:d[0])):e="",C.file=e)}function n(){var a,b,c,d=C.fileName;return A&&null!==d?d:(a=m(),b=a.split("."),c=b.length>1?b.slice(0,-1).join("."):b[0],C.fileName=c)}function o(){var a,b,c,d,e=C.fileExtension;return A&&null!==e?e:(a=m(),b=n(),c=a.replace(b,""),d="."==c[0]?c.replace(".",""):c,C.fileExtension=d)}function p(){var a,b,c=C.directory;return A&&null!==c?c:(a=q(),b=a.join(""),C.directory=b)}function q(){var a,b,c,d=C.directoryList;return A&&null!==d?d:(a=l(),b=m(),c=b?a.slice(0,-1):a,C.directoryList=c)}function r(){var a,b,c,d=C.query;return A&&null!==d?d:(a=j(),b=a.split("?"),c=void 0!==b[1]?b[1].split("#")[0]:"",C.query=c)}function s(){var a,b,c=C.queryList;return A&&null!==c?c:(a=r(),b=a.split("&"),C.queryList=b)}function t(){var a,b,c,d,e,f=C.queryObject;if(A&&null!==f)return f;for(a=s(),b=a.length,e={},c=0;b>c;c++)d=a[c].split("="),void 0!==d[0]&&void 0!==d[1]&&(e[d[0]]=d[1]);return C.queryObject=e}function u(a){var b,c=t(),d=null;for(b in c)c.hasOwnProperty(b)&&b==a&&(d=c[b]);return d}function v(){var a,b,c,d=C.fragment;return A&&null!==d?d:(a=j(),b=a.split("#"),c=void 0!==b[1]?b[1]:"",C.fragment=c)}function w(){return window.location.href}function x(){C=B}function y(){A=!0}function z(){A=!1}var A=!1,B={protocol:null,authorization:null,username:null,password:null,domain:null,port:null,domainList:null,domainLevels:null,request:null,path:null,pathList:null,file:null,fileName:null,fileExtension:null,directory:null,directoryList:null,query:null,queryList:null,queryObject:null,fragment:null},C=B;return a=a?a:w(),function(){var a;return x(),y(),a={protocol:b(),authorization:c(),username:d(),password:e(),domain:f(),port:i(),domainList:g(),domainLevels:h(),request:j(),path:k(),pathList:l(),file:m(),fileName:n(),fileExtension:o(),directory:p(),directoryList:q(),query:r(),queryList:s(),queryObject:t(),fragment:v(),getQueryValue:u},z(),x(),a}()}